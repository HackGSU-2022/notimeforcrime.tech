...
months = st.sidebar.multiselect('Months', ('January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'),
...
def monthly_crime(data):
    ...
    for year in years:
        ...
        time_series = time_series[time_series.occur_datet_new.dt.year == int(
            year)]
