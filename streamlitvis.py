...
st.sidebar.markdown(' #### Select the date range')
...
if not st.sidebar.checkbox("All day", True, key='2'):
    ...
    hour = st.sidebar.multiselect(
        ...
        'Hours:', list(range(24)), default=[5, 6, 7, 8])
...
year = st.sidebar.slider('Year', 2009, 2022)
...
years = st.sidebar.multiselect(
    ...
    'Years', (list(range(2009, 2022))), default=list(range(2009, 2021)))
